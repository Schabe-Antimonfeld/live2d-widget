...
const live2d_path = 'https://fastly.jsdelivr.net/gh/schabe-antimonfeld/live2d-widget@master/dist/';
...
(async () => {
  ...
  initWidget({
    ...
    cubism5Path: 'https://fastly.jsdelivr.net/gh/schabe-antimonfeld/live2d-widget@master/dist/',
