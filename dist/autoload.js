...
const live2d_path = 'https://cdn.jsdelivr.net/gh/schabe-antimonfeld/live2d-widget@latest/dist/';
...
(async () => {
  ...
  initWidget({
    ...
    cdnPath: 'https://cdn.jsdelivr.net/gh/schabe-antimonfeld/live2d-widget@latest/dist/',
